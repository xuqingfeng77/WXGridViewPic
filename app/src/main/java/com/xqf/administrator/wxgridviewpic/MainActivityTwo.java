...
import com.xqf.administrator.wxgridviewpic.utils.ImageBean;
import com.xqf.administrator.wxgridviewpic.utils.PickPhotoUtil;
					...
					public void onItemClick(AdapterView<?> arg0, View arg1,
						...
						if (chooseItem.get(0) == position) {
							...
							if (0 == position) {
								...
								// 刷新当前的GridView
								mDirDialog = ProgressDialog.show(MainActivityTwo.this, null, "正在加载...");
								nowStrs.clear();
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int position,
				...
				if(chooseItem.get(0) == 0 && 0 == position) {
					...
					if(addedPath.size() >= limit_count) {
						Toast.makeText(MainActivityTwo.this, "最多选8张，请取消后再点击拍照", Toast.LENGTH_SHORT).show();
						return;
					}
					...
					PickPhotoUtil.getInstance().takePhoto(
							MainActivityTwo.this, "tempUser", tempCameraPath);
				}
			}
		});
	}
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {
				case SCAN_OK:
					...
					// adapter = new GroupAdapter(MainActivityTwo.this, list =
...
//				.memoryCache(new WeakMemoryCache())
		...
		options = new DisplayImageOptions.Builder().cacheOnDisc()
				...
				.showStubImage(R.mipmap.friends_sends_pictures_no).build();
		...
		toUp = AnimationUtils.loadAnimation(MainActivityTwo.this, R.anim.act_bottom_to_top);
		toDown = AnimationUtils.loadAnimation(MainActivityTwo.this, R.anim.act_top_to_bottom);
		// listAdapter = new ListAdapter();
		// group_listview.setAdapter(listAdapter);
		//
	...
	private void getImages() {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				ContentResolver mContentResolver = MainActivityTwo.this
						.getContentResolver();
	...
	class GridAdapter extends BaseAdapter {
		...
		public GridAdapter() {
			...
			inflater = LayoutInflater.from(MainActivityTwo.this);
		}
